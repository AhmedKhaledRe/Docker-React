...
url=`curl -H "Authorization: Bearer $FIRST_REACT_DOCKER" https://api.netlify.com/api/v1/sites/YOUR_SITE_HERE/deploys`
...
curl -X POST -H "Authorization: Bearer $FIRST_REACT_DOCKER" -d "{}" "https://api.netlify.com/api/v1/sites/YOUR_SITE_HERE/deploys/${temp##*|}/restore"
